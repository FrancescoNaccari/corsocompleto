...
public class ProvaCoomons {
    public static void main(String[] args) {
       ...
       try {
        ...
        prodotti.stream().map(prodotto -> prodotto.getId().longValue()+"@"+
                prodotto.getNome()+"@"+prodotto.getCategoria()+"@"+ prodotto.getPrezzo()).forEach(s-> System.out.println(s));
