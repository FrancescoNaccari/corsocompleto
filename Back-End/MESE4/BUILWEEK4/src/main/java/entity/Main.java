...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        abbonamento1.setDistributore(atmDao.getById(20));
        ...
        // da settare il mezzo ma manca il getter e setter nella classe
        try {
...
//        System.out.println("Numero di biglietti emessi dal ATM ID " + distributoreDao.getById(9)
...
//        System.out.println("Numero di abbonamenti emessi dal rivenditore ID " + distributoreDao.getById(10)
...
//        System.out.println("Manutenzioni del mezzo " + mezzoDao.getById(2) + ":" + manutenzioni1);
//
//        List<PeriodoServizio> periodiServizio = periodoServizioDao.getPeriodiServizioByMezzo(mezzoDao.getById(1));
//        System.out.println("Periodi di servizio del mezzo " + mezzoDao.getById(1) + ":");
...
//        System.out.println("--------------------------------------------------------------------");
//
//        Integer ricerca = mezzoDao.countViaggiByMezzoAndTratta(mezzoDao.getById(1),trattaDao.getById(16));
