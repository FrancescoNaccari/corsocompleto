...
if (numero1 < numero2) {
  ...
  console.log(numero2 + 'è' + numero1 + ' sono uguali')
};
/* ESERCIZIO 2
...
if (totalShoppingCart < 50) {
  ...
  console.log('spese di spedizione comprese' + totalShoppingCart + spedizione);
} else {
...
if (carrelloBlack < 50) {
  ...
  console.log('spese di spedizione comprese' + carrelloBlack)
} else {
  (totalShoppingCart >= 50)
  checkout = carrelloBlack;
  console.log('spedizione gratuita' + carrelloBlack)
};
